const companies = [
    ...
    {name: "Company Thre", category: "Auto", start: 1999, end: 2007},
    {name: "Company Four", category: "Retail", start: 1988, end: 2010},
    {name: "Company Five", category: "Technology", start: 2009, end: 2014},
    {name: "Company Six", category: "Finance", start: 1987, end: 2010},
    {name: "Company Seven", category: "Auto", start: 1986, end: 1996},
    {name: "Company Eight", category: "Technology", start: 2011, end: 2006},
...
// Get 80s companies
const eightyCompanies = companies.filter(company => (company.start >= 
    1980 && company.start < 1990));

// Companies that lasted 10 years 
const tenYears = companies.filter(company => (company.end -
     company.start >= 10));
