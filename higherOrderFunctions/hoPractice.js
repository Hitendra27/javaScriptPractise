...
// const newMap = movies.map(movie => `${movie.Title} - ${movie.Director}`);
...
//filter
// Get movies where director is N/A
// const noDir = [];
// for(let i = 0; i < movies.length; i++) {
//   if(movies[i] === 'N/A') {
//     noDir.push(movies[i]);
...
// Get movies where director is N/A
// const noDir = movies.filter(function(movie){
...
// Arrow Function
// const writer = movies.filter(movie => movie.Year ===
//   '2009');

// console.log(writer);

//map
//map array of movie names
...
// const movieNames = movies.map(movie => movie.Director);

// console.log(movieNames);

// const movieWriters = movies.map(movie => movie.Writer);

// console.log(movieWriters);

// const movieActors = movies.map(movie => movie.Actors);

// console.log(movieActors);

// sort
// const sortMovies = movies.sort((a, b) => b - a);
